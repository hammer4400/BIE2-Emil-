\documentclass[a4paper,11pt,twoside,openany]{memoir} 	% Openright aabner kapitler paa hoejresider (openany = vilkaarlig/begge)
...
% Fix til tekst der overlapper i indholdsfortegnelse %
%\usepackage{tocloft}
...
\makeevenhead{Uni}{Gruppe B125}{}{\leftmark}				% Lige siders sidehoved (\makeevenhead{Navn}{Venstre}{Center}{Hoejre})
...
\lstdefinestyle{mystyle}{
  ...
  keywordstyle=\color{azure(colorwheel)},
  numberstyle=\tiny\color{codegray},
  stringstyle=\color{awesome},
